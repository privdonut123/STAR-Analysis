...
{ 
    ...
    size_t nFttRawHits = 0;
    size_t nFttRawHitsTimed = 0;
    ...
    LOG_INFO << "nFttRawHitsTimed = " << nFttRawHits << endm;
    LOG_INFO << "nFttRawHits = " << nFttRawHits << endm;
