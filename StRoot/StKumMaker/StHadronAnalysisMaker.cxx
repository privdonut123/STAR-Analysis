...
Int_t StHadronAnalysisMaker::Init()
  { // Do once at the start of the analysis, create histograms, etc.
    ...
    h1_num_of_fwd_tracks = new TH1F("h1_num_of_fwd_tracks", "number of forward tracks per event", 11, -1, 10);
    h1_num_of_fwd_tracks->SetXTitle("number of tracks");
    h1_num_of_fwd_tracks->SetYTitle("counts");
    h1_fwd_track_is_primary = new TH1F("h1_fwd_track_is_primary", "forward track is primary", 5, -2, 2);
    ...
    // h1_geant_parent_pt = new TH1F("h1_geant_parent_pt", "transverse momentum distribution of geant parent tracks", bins, 0, 10);
    // h1_geant_parent_pt->SetXTitle("p_{T} [GeV/c]");
    // h1_geant_parent_pt->SetYTitle("counts");
    // h1_geant_parent_pz = new TH1F("h1_geant_parent_pz", "longitudinal momentum distribution of geant parent tracks", bins, 0, 100);
    // h1_geant_parent_pz->SetXTitle("p_{z} [GeV/c]");
    // h1_geant_parent_pz->SetYTitle("counts");
    h1_geant_track_id = new TH1F("h1_geant_track_id", "geant track id", 11, -1, 10);
    h1_geant_track_id->SetXTitle("track id");
    h1_geant_track_id->SetYTitle("counts");
    h1_geant_start_vertex = new TH1F("h1_geant_start_vertex", "geant start vertex", bins, -100, 100);
    h1_geant_start_vertex->SetXTitle("vertex [cm]");
    h1_geant_start_vertex->SetYTitle("counts");
    h1_geant_stop_vertex = new TH1F("h1_geant_stop_vertex", "geant stop vertex", bins, -100, 100);
    h1_geant_stop_vertex->SetXTitle("vertex [cm]");
    h1_geant_stop_vertex->SetYTitle("counts");
    h1_geant_particle_id = new TH1F("h1_geant_particle_id", "geant particle id", 11, -1, 10);
    h1_geant_particle_id->SetXTitle("particle id");
    h1_geant_particle_id->SetYTitle("counts");
    h1_geant_vtx_z = new TH1F("h1_geant_vtx_z", "geant vertex z", bins, -1000, 1000);
    h1_geant_vtx_z->SetXTitle("z [cm]");
    h1_geant_vtx_z->SetYTitle("counts");
    h1_geant_num_of_tracks = new TH1F("h1_geant_num_of_tracks", "number of geant tracks per event", 11, -1, 10);
    h1_geant_num_of_tracks->SetXTitle("number of tracks");
    h1_geant_num_of_tracks->SetYTitle("counts");


    h1_geant_primary_energy = new TH1F("h1_geant_primary_energy", "energy distribution of geant primary tracks", bins, 0, 100);
    h1_geant_primary_energy->SetXTitle("Energy [GeV]");
    h1_geant_primary_energy->SetYTitle("counts");
    ...
    h1_geant_primary_pt = new TH1F("h1_geant_primary_pt", "transverse momentum distribution of primary geant primary tracks", bins, 0, 10);
    ...
    h1_geant_primary_energy = new TH1F("h1_geant_primary_energy", "energy distribution of primary geant primary tracks", bins, 0, 100);
    h1_fwd_track_num_of_fit_points = new TH1F("h1_fwd_track_num_of_fit_points", "forward track number of fit points", 10, 0, 10);
