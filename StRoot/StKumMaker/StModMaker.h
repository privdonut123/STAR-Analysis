#ifndef StModMaker_def
#define StModMaker_def
...
class StModMaker : public StMaker
  {  
    private:
      int start_time;
      //  StEvent* evnt;
    ...
    public:
      //bool makerDebug();
      StModMaker(const char* name = "hello")   ;          //  Constructor
      virtual          ~StModMaker( )   ;          //  Destructor
      ...
      int mDebug = 0;
      float E_min = 1;
      ClassDef(StModMaker,1)                     //  Macro for CINT compatability
  };
